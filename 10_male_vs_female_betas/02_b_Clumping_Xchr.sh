...
plink --bfile /path/Meta-analysis/1000G_Phase3_v5/ALL.chrX.phase3_shapeit2_mvncall_integrated_v1b.20130502.genotypes_rsID_no_missing_dups \
  ...
  --clump-r2 0.1 \
  --clump-kb 1000 \
  --out ${directory}/clumped_Adams_SNPs_chrX
