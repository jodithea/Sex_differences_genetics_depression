...
# This script uses LD score regression to calculate rg for the munged sumstats of male meta-analysis results with other traits
...
directory=/path/04_LDSC/SNPrg/Males/
...
ldsc.py \
  --rg ${Allcohorts_male_MDD},${Allcohorts_female_MDD},${AdamsMDD_sumstats},${BloklandMDDfemale_sumstats},${BloklandMDDmale_sumstats},${SilveiraMDDfemale_sumstats},${SilveiraMDDmale_sumstats},${ADHD_sumstats},${Anxiety_sumstats},${Bipolar_sumstats},${PTSD_sumstats},${Schizophrenia_sumstats},${BMI_sumstats},${Metabolic_syndrome_sumstats},${Waist_to_hip_ratio_sumstats},${EA_sumstats},${BMI_female_sumstats},${BMI_male_sumstats},${Drinks_per_week_sumstats},${Ever_smoked_regularly_sumstats} \
