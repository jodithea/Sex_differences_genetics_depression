...
# Save 
save(S, file = paste0(directory, "UKB_full_sumstats_selection.RData"))

write.table(S, file = paste0(directory, "UKB_full_sumstats_selection.txt"), col.names = T, row.names = F, sep = "\t", quote = F)
...
# Print the result
sink(paste0(directory, "/male_vs_female_S_UKB_full_sumstats.txt"))
