# This script compare polygenicity of females vs males in the UK Biobank full sumstats
...
# Save 
save(pi, file = paste0(directory, "UKB_full_sumstats_polygenicity.RData"))

write.table(pi, file = paste0(directory, "UKB_full_sumstats_polygenicity.txt"), col.names = T, row.names = F, sep = "\t", quote = F)
...
# Print the result
sink(paste0(directory, "/male_vs_female_pi_UKB_full_sumstats.txt"))
