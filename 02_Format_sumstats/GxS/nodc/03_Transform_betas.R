...
AGDS = paste0(directory, "AGDS_MDD_GxS_nodc_sumstats_formatted_formetaanalysis.txt", sep = "")

AllOfUs = paste0(directory, "AllOfUs_MDD_GxS_nodc_sumstats_formatted_formetaanalysis.txt", sep = "")

Bionic = paste0(directory, "Bionic_MDD_GxS_nodc_sumstats_formatted_formetaanalysis.txt", sep = "")

GLAD = paste0(directory, "GLAD_MDD_GxS_nodc_sumstats_formatted_formetaanalysis.txt", sep = "")

UKB = paste0(directory, "UKB_MDD_GxS_nodc_sumstats_formatted_formetaanalysis.txt", sep = "")
...
process_dataframe <- function(df, df_name, cases, controls, directory) {
  ...
  output_file <- paste0(directory, "/", df_name, "_MDD_GxS_nodc_sumstats_formatted_formetaanalysis_transformed.txt")
