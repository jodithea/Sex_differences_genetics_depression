...
munge_sumstats.py \
 --sumstats AGDS_MDD_GxS_fulldc_sumstats_formatted_formetaanalysis_transformed.txt \
 ...
 --out Munged_sumstats/AGDS_MDD_GxS_fulldc_sumstats_formatted_formetaanalysis_transformed_LDSC_munged
...
munge_sumstats.py \
 --sumstats Bionic_MDD_GxS_fulldc_sumstats_formatted_formetaanalysis_transformed.txt \
 --merge-alleles ${reference}w_hm3.noMHC.snplist \
 --snp rsID_build37 \
 --frq FREQA1 \
 --signed-sumstats Z,0 \
 --p P_G_by_E \
 --ignore MARKER_build37,MAF \
 --out Munged_sumstats/Bionic_MDD_GxS_fulldc_sumstats_formatted_formetaanalysis_transformed_LDSC_munged


# UKB

munge_sumstats.py \
 --sumstats UKB_MDD_GxS_fulldc_sumstats_formatted_formetaanalysis_transformed.txt \
 --merge-alleles ${reference}w_hm3.noMHC.snplist \
 --snp rsID_build37 \
 --frq FREQA1 \
 --signed-sumstats Z,0 \
 --p P_G_by_E \
 --ignore MARKER_build37,MAF \
 --out Munged_sumstats/UKB_MDD_GxS_fulldc_sumstats_formatted_formetaanalysis_transformed_LDSC_munged


# GLAD

munge_sumstats.py \
 --sumstats GLAD_MDD_GxS_fulldc_sumstats_formatted_formetaanalysis_transformed.txt \
 --merge-alleles ${reference}w_hm3.noMHC.snplist \
 --snp rsID_build37 \
 --frq FREQA1 \
 --signed-sumstats Z,0 \
 --p P_G_by_E \
 --ignore MARKER_build37,MAF \
 --out Munged_sumstats/GLAD_MDD_GxS_fulldc_sumstats_formatted_formetaanalysis_transformed_LDSC_munged


# Blokland21

munge_sumstats.py \
 --sumstats Blokland21_MDD_GxS_fulldc_sumstats_formatted_formetaanalysis_transformed.txt \
 --merge-alleles ${reference}w_hm3.noMHC.snplist \
 --snp rsID_build37 \
 --frq FREQA1 \
 ...
 --out Munged_sumstats/Blokland21_MDD_GxS_fulldc_sumstats_formatted_formetaanalysis_transformed_LDSC_munged


# All Of Us

awk '{ gsub("NA", "1", $15) ; print }' AllOfUs_MDD_GxS_fulldc_sumstats_formatted_formetaanalysis_transformed.txt > temp_AllOfUs.txt
...
munge_sumstats.py \
 ...
 --p P_G_by_E \
 --ignore MARKER_build37,MAF \
 --out Munged_sumstats/AllOfUs_MDD_GxS_fulldc_sumstats_formatted_formetaanalysis_transformed_LDSC_munged
