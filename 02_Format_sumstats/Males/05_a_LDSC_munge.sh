...
directory=/path/01_Format_sumstats/Males/ # working directory
...
munge_sumstats.py \
 --sumstats AGDS_MDD_male_sumstats_formatted_formetaanalysis.txt \
 --merge-alleles ${reference}w_hm3.noMHC.snplist \
 --snp rsID_build37 \
 --frq FREQA1 \
 --ignore MARKER_build37,MAF \
 --out Munged_sumstats/AGDS_MDD_male_sumstats_formatted_formetaanalysis_LDSC_munged


# Bionic

munge_sumstats.py \
 --sumstats Bionic_MDD_male_sumstats_formatted_formetaanalysis.txt \
 --merge-alleles ${reference}w_hm3.noMHC.snplist \
 --snp rsID_build37 \
 --frq FREQA1 \
 --ignore MARKER_build37,MAF \
 --out Munged_sumstats/Bionic_MDD_male_sumstats_formatted_formetaanalysis_LDSC_munged


# UKB

munge_sumstats.py \
 --sumstats UKB_MDD_male_sumstats_formatted_formetaanalysis.txt \
 --merge-alleles ${reference}w_hm3.noMHC.snplist \
 --snp rsID_build37 \
 --frq FREQA1 \
 --ignore MARKER_build37,MAF \
 --out Munged_sumstats/UKB_MDD_male_sumstats_formatted_formetaanalysis_LDSC_munged


# GLAD

munge_sumstats.py \
 --sumstats GLAD_MDD_male_sumstats_formatted_formetaanalysis.txt \
 --merge-alleles ${reference}w_hm3.noMHC.snplist \
 --snp rsID_build37 \
 --frq FREQA1 \
 --ignore MARKER_build37,MAF \
 --out Munged_sumstats/GLAD_MDD_male_sumstats_formatted_formetaanalysis_LDSC_munged


# Blokland21

munge_sumstats.py \
 --sumstats Blokland21_MDD_male_sumstats_formatted_formetaanalysis.txt \
 --merge-alleles ${reference}w_hm3.noMHC.snplist \
 --snp rsID_build37 \
 --frq FREQA1 \
 --ignore MARKER_build37,INFO,MAF \
 --out Munged_sumstats/Blokland21_MDD_male_sumstats_formatted_formetaanalysis_LDSC_munged


# All Of Us

awk '{ gsub("NA", "1", $12) ; print }' AllOfUs_MDD_male_sumstats_formatted_formetaanalysis.txt > temp_AllOfUs.txt
...
munge_sumstats.py \
 ...
 --frq FREQA1 \
 --ignore MARKER_build37,MAF \
 --out Munged_sumstats/AllOfUs_MDD_male_sumstats_formatted_formetaanalysis_LDSC_munged
