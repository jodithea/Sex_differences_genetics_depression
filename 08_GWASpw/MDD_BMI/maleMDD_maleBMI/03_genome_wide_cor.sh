...
input2_seg=maleBMI.segbfs.gz # fgwas output .segbfs.gz file from 2nd set of summary stats

input2_snp=maleBMI.bfs.gz # fgwas output .bfs file from 2nd set of summary stats

input2_sumstats=maleBMI_sumstats_matched_distinct.txt # 2nd set of summary stats

output=maleMDD_maleBMI # name of output file that will print correlation between the two traits
