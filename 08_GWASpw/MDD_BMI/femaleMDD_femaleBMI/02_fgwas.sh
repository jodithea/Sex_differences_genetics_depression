...
directory=/path/06_GWAS_pw/MDD_BMI/femaleMDD_femaleBMI_update/

reference=/path/gwaspw_reference/ # location of reference directory where .bed file is located

input1=female_MDD_sumstats_formatted_fgwas.txt # 1st set of sum stats that are formatted for fgwas

input2=female_BMI_sumstats_formatted_fgwas.txt # 2nd set of sum stats that are formatted for fgwas

output1=femaleMDD # name of fgwas output based on 1st set of sum stats

output2=femaleBMI # name of fgwas output based on 2nd set of sum stats
