...
# This script uses GWAS-pw to identify loci that influence female MDD and female BMI
...
input=femaleMDD_femaleBMI_sumstats_formatted_gwaspw.txt # summary stats of two traits combined and formatted for use in gwas-pw

correlation=0.05120672 # correlation of two traits using only SNPs not correlated with either trait (as output from previous step)

pheno1=femaleMDD # name of phenotype 1 = after "_" in input file

pheno2=femaleBMI # name of phenotype 2 = after "_" in input file

output=GWAS_pw_femaleMDD_femaleBMI # name of gwas-pw output files
