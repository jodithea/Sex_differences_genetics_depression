...
# 	model 1 [association only to phenotype 1 (femaleMDD)] versus the null
#	model 2 [association only to phenotype 2 (femaleBMI)] versus the null
...
input=GWAS_pw_femaleMDD_femaleBMI.segbfs.gz
