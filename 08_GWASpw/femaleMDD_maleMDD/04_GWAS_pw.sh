...
# This script uses GWAS-pw to identify loci that influence MDD in both females and males
...
input=female_male_MDD_sumstats_formatted_gwaspw_no_chr23_removed_multiallelics.sorted # summary stats of two traits combined and formatted for use in gwas-pw

correlation=0.0972477 # correlation of two traits using only SNPs not correlated with either trait (as output from previous step)

output=GWAS_pw_femaleMDD_maleMDD # name of gwas-pw output files
