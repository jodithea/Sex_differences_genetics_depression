...
# 	model 1 [association only to phenotype 1 (female)] versus the null
#	model 2 [association only to phenotype 2 (male)] versus the null
...
directory=/path/06_GWAS_pw/

input=GWAS_pw_femaleMDD_maleMDD.segbfs.gz
