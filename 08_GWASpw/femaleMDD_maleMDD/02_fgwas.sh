...
input1=female_MDD_sumstats_formatted_fgwas_no_chr23_removed_multiallelics.sorted # 1st set of sum stats that are formatted for fgwas

input2=male_MDD_sumstats_formatted_fgwas_no_chr23_removed_multiallelics.sorted # 2nd set of sum stats that are formatted for fgwas

output1=femaleMDD # name of fgwas output based on 1st set of sum stats

output2=maleMDD # name of fgwas output based on 2nd set of sum stats
