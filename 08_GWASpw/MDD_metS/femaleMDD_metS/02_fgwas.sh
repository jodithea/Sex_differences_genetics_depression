...
directory=/path/06_GWAS_pw/MDD_metS/femaleMDD_metS/
...
input2=metS_sumstats_formatted_fgwas.txt # 2nd set of sum stats that are formatted for fgwas

output1=femaleMDD # name of fgwas output based on 1st set of sum stats

output2=metS # name of fgwas output based on 2nd set of sum stats
