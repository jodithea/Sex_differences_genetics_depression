...
# This script uses GWAS-pw to identify loci that influence male MDD and metabolic syndrome
...
input=maleMDD_metS_sumstats_formatted_gwaspw.txt # summary stats of two traits combined and formatted for use in gwas-pw

correlation=0.002938259 # correlation of two traits using only SNPs not correlated with either trait (as output from previous step)

pheno1=maleMDD # name of phenotype 1 = after "_" in input file

pheno2=metS # name of phenotype 2 = after "_" in input file

output=GWAS_pw_maleMDD_metS # name of gwas-pw output files
