...
plink --bfile /path/Meta-analysis/1000G_Phase3_v5/ALL.chr${chr}.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes_CHRBPA1A2_no_missing_dups \
  ...
  --clump-r2 0.1 \
  --clump-kb 1000 \
  --out ${directory}/clumped_female_chr${chr}
